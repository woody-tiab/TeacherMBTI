    ...
    <Layout showHeader={false} maxWidth="4xl">
      <div className="space-y-8">
        ...
        >
          ...
          >
            <motion.p 
              className="text-gray-700 mb-8 text-lg md:text-xl leading-relaxed text-balance break-korean"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2, duration: 0.6 }}
            >
              24개의 교육 상황별 질문을 통해 당신의 수업 스타일을 <span className="font-semibold text-indigo-600">16가지 MBTI 타입</span>으로 분석해드립니다.
            </motion.p>
            ...
            >
              {hasSavedTest ? (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button 
                      ...
                      className="px-8 py-4 text-lg md:text-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 bg-gradient-to-r from-green-500 to-blue-600"
                    >
                      📋 테스트 계속하기
                    </Button>
                    <Button 
                      ...
                      className="px-8 py-4 text-lg md:text-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                    >
                      🆕 새로 시작하기
                    </Button>
                  </div>
                ...
                <Button 
                  ...
                  className="px-10 py-4 text-lg md:text-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 bg-gradient-to-r from-blue-500 to-purple-600"
                >
                  🎯 테스트 시작하기
                </Button>
              )}
            ...
            >
              <div className="p-6 bg-white rounded-xl shadow-sm border border-blue-100">
                ...
                <div className="font-semibold text-blue-700 mb-2 text-base md:text-lg">24개 질문</div>
                <div className="text-sm md:text-base text-gray-600 break-korean">교육 현장의 다양한 상황을 다루는 실제적인 질문들</div>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-sm border border-green-100">
                <div className="text-2xl mb-3">⏱️</div>
                <div className="font-semibold text-green-700 mb-2 text-base md:text-lg">10분 소요</div>
                <div className="text-sm md:text-base text-gray-600 break-korean">빠르고 간편한 진단으로 즉시 결과 확인</div>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-sm border border-purple-100">
                <div className="text-2xl mb-3">🎨</div>
                <div className="font-semibold text-purple-700 mb-2 text-base md:text-lg">16가지 타입</div>
                <div className="text-sm md:text-base text-gray-600 break-korean">개인화된 수업 스타일과 교육 방법 제시</div>
              </div>
            </motion.div>
          </Card>
        </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 break-korean">자신의 교육 방식을 점검하고 싶은 분</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
                    <span className="text-red-600">🔍</span>
                  </div>
                  <span className="text-gray-700 break-korean">효과적인 수업 전략을 찾고 싶은 분</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span className="text-indigo-600">🚀</span>
                  </div>
                  <span className="text-gray-700 break-korean">교육 역량을 한 단계 업그레이드하고 싶은 분</span>
                </div>
              </div>
            </div>
            
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-gray-600 md:text-lg mb-4 break-korean">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {(() => {
                ...
                return examples.map((example, index) => (
                  ...
                  >
                    <div className={`w-12 h-8 ${example.color} rounded-lg flex items-center justify-center mb-2`}>
                      <span className="text-white text-xs md:text-sm font-bold">{example.type}</span>
                    </div>
                    <div className="font-semibold text-gray-800 mb-1 text-sm md:text-base">{example.name}</div>
                    <div className="text-xs md:text-sm text-gray-600 leading-relaxed break-korean">{example.description}</div>
                  </motion.div>
                ));
              })()}
            </div>
