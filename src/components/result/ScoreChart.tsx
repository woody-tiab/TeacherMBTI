                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        style={{ 
                          background: isLeftDominant 
                            ? `linear-gradient(to right, ${typeColor}, ${typeColor}88)`
                      ...
                      <motion.div
                        ...
                        style={{ 
                          background: !isLeftDominant
                            ? `linear-gradient(to left, ${typeColor}, ${typeColor}88)`
                            : 'linear-gradient(to left, #9ca3af, #6b7280)'
                        }}
                        initial={{ width: "50%" }}
                    ...
                    >
                      <div className="flex items-center space-x-2 mb-2">
                        <div 
                          ...
                          style={{ 
                            backgroundColor: isLeftDominant ? typeColor : '#6b7280'
                          }}
                        />
