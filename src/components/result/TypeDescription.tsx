    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <Card className="space-y-4">
          <div className="flex items-center space-x-3">
            <div 
              className="w-8 h-8 rounded-full flex items-center justify-center bg-orange-500"
            >
          ...
          <ul className="space-y-3" role="list">
            {typeInfo.tips.map((tip, index) => (
              <motion.li
                ...
                transition={{ delay: 0.1 * index, duration: 0.4 }}
                className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-200 hover:bg-blue-100 transition-colors duration-200"
              >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {typeInfo.compatibleStudentTypes.map((studentType, index) => (
              ...
              >
                ...
                <span className="text-gray-700 text-sm">{studentType}</span>
              </motion.div>
            ))}
          </div>
        </Card>
